...
class Address(models.Model):
    ...
    def __str__(self):
        return f"{self.country}, {self.city}, {self.street} {self.building} {self.floor} {self.appertment} {self.pochta_code}"

class OrderSave(models.Model):
    class Meta:
        verbose_name = "buyurtma"
        verbose_name_plural = "buyurtmalar"
    client = models.ForeignKey(ClientProfile, on_delete=models.CASCADE, null=True, verbose_name="Mijoz")
...
class OrderProduct(models.Model):
    order = models.ForeignKey(OrderSave, on_delete=models.CASCADE, related_name="order_products")
